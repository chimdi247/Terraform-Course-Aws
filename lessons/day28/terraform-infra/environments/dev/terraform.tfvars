...
# SSH Configuration
ssh_key_name     = "key-1"  # REQUIRED: Replace with your key pair name
...
frontend_docker_image = "chimdi247/goal-tracker-frontend:latest"
backend_docker_image  = "chimdi247/goal-tracker-backend:latest"
